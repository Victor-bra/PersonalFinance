...
public final class SaveData {
    ...
    private void sort() {
        this.articles.sort(
                (Article a, Article a1) -> a.getTitle().compareToIgnoreCase(a1.getTitle())
        );
        this.accounts.sort(
                (Account a, Account a1) -> a.getTitle().compareToIgnoreCase(a1.getTitle())
        );
        this.transactions.sort(
                (Transaction t, Transaction t1) -> (int) t1.getDate().compareTo(t.getDate())
        );
        this.transfers.sort(
                (Transfer t, Transfer t1) -> (int) t1.getDate().compareTo(t.getDate())
        );
