...
public final class Style {
    ...
    public static final Font FONT_BUTTON_TOOLBAR = new Font("Eirik_Raude", Font.BOLD, 14);
    public static final Font FONT_MAIN_BUTTON = new Font("Eirik_Raude", Font.BOLD, 14);
    public static final Font FONT_DIALOG_LABEL = new Font("Eirik_Raude", Font.BOLD, 12);
    public static final Font FONT_LABEL_HEADER = new Font("Eirik_Raude", Font.BOLD, 16);
    public static final Font FONT_LABEL_LEFT_PANEL_CURRENCY = new Font("Eirik_Raude", Font.BOLD, 14);
    public static final Font FONT_LABEL_LEFT_PANEL_AMOUNT = new Font("Eirik_Raude", Font.PLAIN, 14);
    public static final Font FONT_TABLE_HEADER = new Font("Eirik_Raude", Font.BOLD, 16);
    public static final Font FONT_TABLE = new Font("Eirik_Raude", Font.PLAIN, 14);
    public static final Font FONT_BUTTON_FILTER = new Font("Eirik_Raude", Font.BOLD, 12);
    ...
    public static final EmptyBorder BORDER_FUNCTION_TOOLBAR = new EmptyBorder(5, 5, 5, 5);
    ...
    public static final Dimension DIMENSION_PADDING_PANEL = new Dimension(10, 0);
    ...
    public static final Dimension DIMENSION_CHART = new Dimension(700, 400);
