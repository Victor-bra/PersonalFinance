...
public class TransferAddEditDialog extends AddEditDialog {
    ...
    protected void init() {
        ...
        components.put("LABEL_TO_ACCOUNT", new CommonComboBox(SaveData.getInstance().getArticles().toArray()));
    ...
    protected void setValues() {
        ...
        values.put("LABEL_FROM_ACCOUNT", transfer.getFromAmount());
        values.put("LABEL_TO_ACCOUNT", transfer.getToAmount());
